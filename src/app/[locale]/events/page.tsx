...
import { Calendar, Users, Clock, MapPin, Star, Wine, ChefHat, Music } from 'lucide-react';
...
const featuredEvents = [
  {
    ...
    description: 'Experience a curated selection of premium Italian wines paired with authentic antipasti and live acoustic music.',
    description_de: 'Verkostung ausgewählter italienischer Weine mit passenden Antipasti und Live-Musik.',
    date: '2024-12-28',
    time: '19:00',
    capacity: 30,
    price: 45,
    ...
    featured: true,
    image: '🍷',
    highlights: ['Premium Italian wines', 'Artisanal antipasti', 'Live acoustic music', 'Wine expert guidance']
  },
  {
    id: 2,
    title: 'Pasta Making Masterclass',
    title_de: 'Pasta-Kochkurs',
    description: 'Learn the secrets of perfect pasta preparation from our head chef in this hands-on cooking experience.',
    description_de: 'Lernen Sie die Geheimnisse der perfekten Pasta-Zubereitung von unserem Chefkoch.',
    date: '2025-01-15',
    time: '18:00',
    capacity: 15,
    price: 65,
    ...
    featured: true,
    image: '🍝',
    highlights: ['Hands-on cooking', 'Traditional techniques', 'Take-home recipes', 'Chef guidance']
  },
  {
    id: 3,
    title: 'Truffle Season Special',
    title_de: 'Trüffel-Saison Spezial',
    description: 'Indulge in our exclusive truffle menu featuring fresh Italian truffles in a 5-course tasting menu.',
    description_de: 'Genießen Sie unser exklusives Trüffel-Menü mit frischen italienischen Trüffeln in einem 5-Gänge-Menü.',
    date: '2025-02-14',
    time: '20:00',
    capacity: 25,
    price: 85,
    ...
    featured: true,
    image: '🍄',
    highlights: ['Fresh Italian truffles', '5-course tasting', 'Wine pairings', 'Limited availability']
  }
];
...
export default async function EventsPage({
  ...
  const getEventDescription = (event: any) => {
    return locale === 'de' && event.description_de ? event.description_de : event.description;
  };
                  ...
                  <div className="relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Highlights */}
                        <div>
                          <h4 className="font-semibold text-foreground mb-3">{t('whats_included')}:</h4>
              ...
              {upcomingEvents.map((event) => (
                ...
                >
                  ...
                  <div className="space-y-2 text-sm text-center">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      <Star className="w-4 h-4 text-primary" />
                      <span>€{event.price} {t('per_person')}</span>
                    </div>
                  </div>
