...
import { Clock, Phone, Mail, MapPin, Users, Calendar, Star } from 'lucide-react';
              ...
              <div className="grid gap-6">
                ...
                <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-border hover:shadow-lg transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-2">{t('phone_reservations')}</h3>
                      <p className="text-muted-foreground mb-2">
                        <a href="tel:+4930883215600" className="text-primary hover:text-primary/80 transition-colors text-lg font-medium">
                          030 8832156
                        </a>
                      </p>
                ...
                <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-border hover:shadow-lg transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-2">{t('email_heading')}</h3>
                      <p className="text-muted-foreground mb-2">
                        <a href="mailto:reservierung@ristorante-la-cantina.de" className="text-primary hover:text-primary/80 transition-colors">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground space-y-1">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">5:00 PM - 12:00 AM</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Sunday</span>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-card/30 backdrop-blur-sm rounded-3xl border border-border hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-4">Authentic Experience</h3>
                <p className="text-muted-foreground">
                  Traditional Italian recipes passed down through generations, prepared with love and passion.
                </p>
              </div>
              ...
              <div className="text-center p-8 bg-card/30 backdrop-blur-sm rounded-3xl border border-border hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-4">Perfect Atmosphere</h3>
                <p className="text-muted-foreground">
                  Cozy Italian ambiance perfect for romantic dinners, family gatherings, and business meetings.
                </p>
              </div>
              ...
              <div className="text-center p-8 bg-card/30 backdrop-blur-sm rounded-3xl border border-border hover:shadow-xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-xl font-serif font-bold text-foreground mb-4">{t('prime_location')}</h3>
                <p className="text-muted-foreground">
