        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/admin/menu" className="bg-card rounded-lg border border-border p-4 hover-elevate transition-all">
                <div className="text-center">
                  <ChefHat className="w-6 h-6 text-primary mx-auto mb-2" />
                  <p className="text-sm font-medium text-foreground">{t('new_dish')}</p>
                </div>
              </Link>
              <Link href="/admin/reservations" className="bg-card rounded-lg border border-border p-4 hover-elevate transition-all">
                <div className="text-center">
                  <Calendar className="w-6 h-6 text-primary mx-auto mb-2" />
                  <p className="text-sm font-medium text-foreground">{t('add_reservation')}</p>
                </div>
              </Link>
              <Link href="/admin/gallery" className="bg-card rounded-lg border border-border p-4 hover-elevate transition-all">
                <div className="text-center">
                  <Image className="w-6 h-6 text-primary mx-auto mb-2" />
                  <p className="text-sm font-medium text-foreground">{t('add_photo')}</p>
                </div>
              </Link>
              <Link href="/admin/events" className="bg-card rounded-lg border border-border p-4 hover-elevate transition-all">
                <div className="text-center">
